...
export const ToolConsole: React.FC = () => {
  ...
  // Wrap executeTool with error handling and loading state
  const executeTool = useCallback(async (toolId: string, parameters: Record<string, unknown>) => {
    if (!selectedServer) {
