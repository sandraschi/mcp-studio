...
# Prometheus metrics disabled to avoid duplication issues
# TODO: Implement proper metrics registry management
API_REQUESTS_TOTAL = None
API_REQUEST_DURATION = None
ACTIVE_CONNECTIONS = None
SCAN_PROGRESS_TOTAL = None
SCAN_PROGRESS_FOUND = None
SCAN_PROGRESS_SKIPPED = None
SCAN_PROGRESS_ERRORS = None
REPO_TOOLS = None
