...
from prometheus_client import Counter, Histogram, Gauge  # type: ignore[import]
...
SCAN_DURATION = Histogram(
    'repo_scan_duration_seconds',
    'Time spent scanning repositories',
    ['status']
)
SCAN_REPOS_FOUND = Counter(
    'repo_scan_repos_found_total',
    'Number of MCP repositories found during scans'
)
SCAN_REPOS_SKIPPED = Counter(
    'repo_scan_repos_skipped_total',
    'Number of repositories skipped during scans'
)
SCAN_ERRORS = Counter(
    'repo_scan_errors_total',
    'Number of errors encountered during repo scans'
)
