...
MCP_CLIENT_DATABASE: Dict[str, MCPClientMetadata] = {
    ...
    "antigravity-ide": MCPClientMetadata(
        ...
        short_description="Google's AI-powered code editor with MCP support",
        full_description="Antigravity is Google's AI-powered code editor featuring advanced code completion, chat, and native MCP support for extending with custom tools.",
