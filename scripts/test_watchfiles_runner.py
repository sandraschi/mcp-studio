#!/usr/bin/env python3
"""
Test script for MCP Studio Watchfiles Runner

This script tests the crashproof runner functionality without actually running MCP Studio.
...
class TestProcessRunner(CrashproofRunner):
    """Test version that uses a simple test command instead of MCP Studio."""
...
async def main():
    """Run all tests."""
    print("Starting MCP Studio Watchfiles Runner Tests")
    print("=" * 50)
