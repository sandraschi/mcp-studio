"""
Authentication and Authorization Module for MCP Studio API

This module handles user authentication and authorization for the MCP Studio API.
"""
...
from mcp_studio.tools import tool, structured_log
